...
class LineSegment {
	public:
		...
		//Only fields are the two endpoints of the line segment
...
//Not every vector of points represents a valid simple polygon so if we exposed the vertices directly it could be possible to put an object into an
