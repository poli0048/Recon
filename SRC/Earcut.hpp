//Earcut stand-alone polygon triangulation module. This is taken from Mapbox, with their
//licence added inline. Original came from: https://github.com/mapbox/earcut.hpp
//
//ISC License
//
