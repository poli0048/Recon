// This file contains declarations for embedded icons, which can be loaded by ImGUI
// Author: Bryan Poling

#include <cstdint>

extern const uint8_t Icon_QuadCopterTopView_Light_42x42[];
...
extern const uint8_t Icon_Play_84x84[];
